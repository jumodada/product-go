...
import (
	"Product-A/common/conf"
	"Product-A/common/datasourse"
	"Product-A/fronted/middleware"
	"Product-A/fronted/web/controllers"
	_0_RabbitMQ "Product-A/rabbitmq"
	"Product-A/repositories"
	"Product-A/services"
	"context"
